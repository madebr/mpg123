...
extern float __attribute__((aligned(16))) costab_mmxsse[];
...
void dct64_sse(real *a,real *b,real *c)
{
...

    {
        ...
        asm(
            ...
            "movaps    %3, %%xmm2\n\t"
            :
            :"m"(one), "m"(costab_mmxsse[28]), "m"(costab_mmxsse[29]), "m"(*ppnn)
           );
    ...
    */
    ...
    out0[0] = (short)((b2[0] - b2[1]) * costab_mmxsse[30]);
    out1[128] = (short)((b2[3] - b2[2]) * costab_mmxsse[30]);
    out0[128] = (short)((b2[3] - b2[2]) * costab_mmxsse[30] + b2[3] + b2[2]);
    out1[192] = (short)((b2[7] - b2[6]) * costab_mmxsse[30]);
    out0[192] = (short)((b2[7] - b2[6]) * costab_mmxsse[30] + b2[6] + b2[7] + b2[4] + b2[5]);
    out0[64] = (short)((b2[7] - b2[6]) * costab_mmxsse[30] + b2[6] + b2[7] + (b2[4] - b2[5]) * costab_mmxsse[30]);
    out1[64] = (short)((b2[7] - b2[6]) * costab_mmxsse[30] + (b2[4] - b2[5]) * costab_mmxsse[30]);
    ...
    */
    asm(
        ...
        "ffreep %%st(0)\n\t"
        :
        :"m"(costab_mmxsse[30]), "r"(b1), "r"(b2), "r"(a), "r"(b)
        :"memory"
        );
#endif
    out1[0] = out0[0];
